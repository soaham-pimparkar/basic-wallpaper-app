  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        secondarySwatch: Colors.deepOrange,
        tertiarySwatch: Colors.deepPurple

        )*/
        primarySwatch: Colors.orange,
      ),
      home: const MyHomePage(title: 'Barve sig Home Page'),
    );
  }
}
...
class firstApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          primarySwatch: Colors.orange),
      home: const firstHome(title: 'sig ass 1'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            const Text('Space Image by NASA'),
          ]
        )
      )
    );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/desktoppage': (context) => desktopPage(),
      },
    );
  }
}
